# Generating EV profiles from probability distributions defined in
# https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=8442988&tag=1

# Gaussian mixture model (GMMs) from scikit learn
# https://scikit-learn.org/stable/modules/generated/sklearn.mixture.GaussianMixture.html#sklearn.mixture.GaussianMixture.set_params
...
def assign_cars_to_nodes(spot_loads, total_EVs=1200):
